...
print(' Extracting process from Video to Image is completed!,')
###
...
parser.add_argument('--load_size', default = 600)
...
start_time = start_time.strftime('%Y/%m/%d %H시 %M분 %S초')
detection_time = detection_time.strftime('%Y/%m/%d %H시 %M분 %S초')
extraction_time = extraction_time.strftime('%Y/%m/%d %H시 %M분 %S초')
end_time = end_time.strftime('%Y/%m/%d %H시 %M분 %S초')
...
print('  Image style     : ', img_style)
print('  Start time      : ', start_time)
print('  Detection time  : ', detection_time)
print('  Extraction time : ', extraction_time)
print('  Conversion time : ', end_time)
print('  ')
print(' Conversion process from Video_Image to Cartoon_Image is completed!,')
print('  ')
print('=-=-=-=-=-=-=') 
print('  ')
